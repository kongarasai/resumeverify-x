...
const trust_score_controller_1 = require("./trust-score.controller");
...
exports.TrustScoreModule = TrustScoreModule = __decorate([
    (0, common_1.Module)({
        controllers: [trust_score_controller_1.TrustScoreController],
        providers: [trust_score_service_1.TrustScoreService],
